...
if exist "C:\raylib\w64devkit\bin\g++.exe" (
    ...
    C:\raylib\w64devkit\bin\g++.exe src\main.cpp -o punic_wars.exe -IC:\raylib\raylib\include -LC:\raylib\raylib\lib -lraylib -lopengl32 -lgdi32 -lwinmm
) else if exist "C:\raylib\mingw\bin\g++.exe" (
    echo Using Raylib MinGW...
    C:\raylib\mingw\bin\g++.exe src\main.cpp -o punic_wars.exe -IC:\raylib\include -LC:\raylib\lib -lraylib -lopengl32 -lgdi32 -lwinmm
) else if exist "C:\MinGW\bin\g++.exe" (
    echo Using system MinGW...
    C:\MinGW\bin\g++.exe src\main.cpp -o punic_wars.exe -lraylib -lopengl32 -lgdi32 -lwinmm
) else (
